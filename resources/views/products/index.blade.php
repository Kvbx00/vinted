...
<main class="container">
    ...
    <div class="row">
        <div class="sort">
            <form action="{{ route('search.products') }}" method="get" class="form-group" id="sortForm">
                <select class="form-control selectpicker" id="sort_by" name="sort_by">
                ...
                @foreach ($products as $product)
                    <div class="product-item">
                        <div class="product-user">
                            ...
                            <img src="{{ $product['user']['photo']['thumbnails'][4]['url'] }}" alt="{{ $product['brand_title'] }} {{ $product['title'] }}" id="user-photo">
                            @else
                                <img id="user-photo">
                            @endif
                        ...
                        <div class="product-image">
                            <a href="{{ $product['url'] }}"><img src="{{ $product['photo']['thumbnails'][1]['url'] }}" alt="{{ $product['brand_title'] }} {{ $product['title'] }}" ></a>
                        </div>
                        <div class="product-details">
                            ...
                            <div class="details-row2">
                                <p class="price-fee">{{ $product['total_item_price'] }}  zł, w tym</p>
                                    <div id="fav" class="favorite-icon">
                                        <svg id="shield" viewBox="0 0 16 16"><path d="m7.34 8.3 3.56-3.58 1.07 1-4.62 4.67-2.89-2.82 1.06-1Zm7.33-5.9V8c0 5.6-6.67 8-6.67 8s-6.67-2.4-6.67-8V2.4L8 0Zm-1.5 1.05L8 1.59 2.83 3.45V8a6.31 6.31 0 0 0 2.76 4.92 13.09 13.09 0 0 0 2 1.28l.37.17.37-.17a13.09 13.09 0 0 0 2-1.28A6.31 6.31 0 0 0 13.17 8Z"></path></svg>
                                    </div>
                            </div>
